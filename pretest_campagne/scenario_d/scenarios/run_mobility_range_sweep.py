...
values are written to ``results/pretest_campagne/scenario_d/mobility_range_metrics.csv``.
...
Example usage::
    ...
    python pretest_campagne/scenario_d/scenarios/run_mobility_range_sweep.py \
        --nodes 200 --packets 50 --replicates 10 --seed 42 \
        --results results/pretest_campagne/scenario_d/mobility_range_metrics_custom.csv
...
RESULTS_PATH = mne3sd_results_file("scenario_d", "mobility_range_metrics.csv")
