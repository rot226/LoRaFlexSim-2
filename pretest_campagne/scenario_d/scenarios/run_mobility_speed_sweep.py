...
``results/pretest_campagne/scenario_d/mobility_speed_metrics.csv``.
...
Example usage::
    ...
    python pretest_campagne/scenario_d/scenarios/run_mobility_speed_sweep.py \
        --nodes 200 --replicates 10 --seed 42 \
        --speed-profiles "pedestrian: (0.5, 1.5)" \
        --speed-profiles "urban: (1.5, 3.5)" \
        --results results/pretest_campagne/scenario_d/mobility_speed_metrics_custom.csv
