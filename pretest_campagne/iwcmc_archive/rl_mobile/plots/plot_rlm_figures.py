"""Génère les figures RLM1–RLM8 (format IEEE) à partir des CSV pretest_campagne/iwcmc_archive RL mobile."""
...
DEFAULT_OUTPUT_DIR = ROOT_DIR / "pretest_campagne/iwcmc_archive" / "rl_mobile" / "figures"
