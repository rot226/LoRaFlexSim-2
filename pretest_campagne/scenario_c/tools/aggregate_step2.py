...
from pretest_campagne.scenario_c.common.csv_io import STEP2_EXPECTED_METRICS, aggregate_results, atomic_write_csv
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        help="Dossier des résultats Step2 (défaut: pretest_campagne/scenario_c/step2/results).",
    )
    return parser
