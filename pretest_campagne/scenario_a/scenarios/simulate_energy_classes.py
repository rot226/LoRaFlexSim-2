...
``results/pretest_campagne/scenario_a/energy_consumption.csv``.  Each configuration can be
...
.. code-block:: console
   ...
   python -m pretest_campagne.scenario_a.scenarios.simulate_energy_classes \\
