...
to ``results/pretest_campagne/scenario_a/class_density_metrics.csv`` for later analysis.
...
Example usage::
    ...
    python pretest_campagne/scenario_a/scenarios/run_class_density_sweep.py \
...
RESULTS_PATH = mne3sd_results_file("scenario_a", "class_density_metrics.csv")
