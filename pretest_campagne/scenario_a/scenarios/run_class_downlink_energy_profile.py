...
persists them to ``results/pretest_campagne/scenario_a/class_downlink_energy.csv``.

Example usage::

    python -m pretest_campagne.scenario_a.scenarios.run_class_downlink_energy_profile \
