...
| **Point d’entrée principal** | Les scripts `pretest_campagne.scenario_b.scenarios.run_mobility_*` ou le batch `python -m scripts.mne3sd.run_all_scenario_exports --target scenario_b`. |
