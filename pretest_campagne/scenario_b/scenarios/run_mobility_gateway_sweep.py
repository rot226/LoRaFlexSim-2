...
``results/pretest_campagne/scenario_b/mobility_gateway_metrics.csv``.
...
Example usage::
    ...
    python pretest_campagne/scenario_b/scenarios/run_mobility_gateway_sweep.py \
        --gateways-list 1,2,4 --nodes 200 --replicates 10 --seed 42 \
        --results results/pretest_campagne/scenario_b/mobility_gateway_metrics_custom.csv
"""
